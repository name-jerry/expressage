<script>
	export default {
		...
		methods: {
			submit() {
				if (this.form.userName == null || this.form.password == null || this.form.password2 == null || this.form
					.sex == null) {
					this.msg = '请输入完整'
					this.show = true
					return
				...
				this.axios({
					...
					.then(res => {
						console.log(res);
						if (res.data.errcode == 0) return this.$router.push('/enter/login');
						this.loading = false;
...
<template>
	...
	<div class='test'>
		<div class="prepend">账号:</div>
	<el-input v-model="form.userName" placeholder="请输入账号">
		<!-- <template #prepend class="test">账号:</template> -->
	</el-input>
	</div>
	<div class='test'>
...
<!-- 	<el-input v-model="form.phone" name="phone" type="tel" placeholder="手机号">
	...
	<el-input v-model="form.address" name="address" type="textarea" maxlength="30" show-word-limit placeholder="请输入地址"
